    ...
    <main className=" relative max-w-8xl overflow-hidden">
      <div className="flex w-screen bg-gradient-to-tr from-purple-100  to-purple-200">
        {slides.map((item, i) => (
          <section
            key={i}
            className="w-screen h-[40vh] md:h-screen relative flex-shrink-0 flex items-center justify-center gap-2 md:gap-6 px-4 md:px-12  transition-transform duration-700 ease-out"
